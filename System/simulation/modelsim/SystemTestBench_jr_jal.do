...
add wave -noupdate -radix unsigned /SystemTestBench_jr_jal/Present_state
add wave -noupdate -radix unsigned /SystemTestBench_jr_jal/UUT/datapath/PC/BusMuxIn
...
WaveRestoreCursors {{Cursor 1} {702391 ps} 0}
