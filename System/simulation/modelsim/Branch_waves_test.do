...
add wave -noupdate -radix unsigned /SystemTestBench_branch/Present_state
...
add wave -noupdate {/SystemTestBench_branch/UUT/memory512x32/FullMemorySpace[0]}
add wave -noupdate {/SystemTestBench_branch/UUT/memory512x32/FullMemorySpace[1]}
add wave -noupdate {/SystemTestBench_branch/UUT/memory512x32/FullMemorySpace[2]}
add wave -noupdate {/SystemTestBench_branch/UUT/memory512x32/FullMemorySpace[3]}
add wave -noupdate {/SystemTestBench_branch/UUT/memory512x32/FullMemorySpace[4]}
add wave -noupdate {/SystemTestBench_branch/UUT/memory512x32/FullMemorySpace[5]}
add wave -noupdate {/SystemTestBench_branch/UUT/memory512x32/FullMemorySpace[6]}
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {783930 ps} 0}
...
update
WaveRestoreZoom {0 ps} {393635 ps}
