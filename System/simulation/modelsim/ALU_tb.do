...
add wave -noupdate -radix hexadecimal /SystemTestBench_ALU/UUT/datapath/R2/BusMuxIn
add wave -noupdate -radix hexadecimal /SystemTestBench_ALU/UUT/datapath/R1/BusMuxIn
add wave -noupdate -radix hexadecimal /SystemTestBench_ALU/UUT/datapath/IR/BusMuxIn
add wave -noupdate -radix hexadecimal /SystemTestBench_ALU/UUT/datapath/PC/BusMuxIn
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {84822 ps} 0}
...
update
WaveRestoreZoom {0 ps} {289972 ps}
